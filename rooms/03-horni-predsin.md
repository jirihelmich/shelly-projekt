...
Jedno ovládací místo:
- **U schodů:** 1 rámeček se 2 jednovypínači vedle sebe (SW-H1 + SW-H2)

Druhý paralelní vypínač lustru je v **Chodbě u pokoje** (SW-CP) — viz [05-chodba-u-pokoje.md](05-chodba-u-pokoje.md).
...
- SW-CP stisk (z chodby u pokoje) → přes stávající drát → SH-03 SW1 paralelně → stejný efekt

## Ověřit

- [ ] Stávající schodišťákový drát mezi SW-H2 (u schodů) a SW-CP (chodba u pokoje) existuje (2 volné vodiče)?
