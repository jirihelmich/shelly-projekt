...
| SW-D | D2 | L-04 Lustr jídelna | non-HUE | SH-06 SW2 | detached → HA → SH-04 toggle |
...
## Zapojení SH-06 K2 (detached, cross-room toggle pro Lustr jídelna)

- SW-D2 (tlačítko v obývákovém rámečku, v nákresu označeno „Lustr K") ve skutečnosti ovládá **Lustr jídelna (L-04)**
- SW-D2 → SH-06 SW2 vstup (detached, event-only)
- SH-06 výstup O2: **nezapojit** (L-04 spíná SH-04 v jídelně, ne SH-06)
- V HA: disable entity `switch.sh_06_output_2`
- V HA: `event.sh_06_input_2` → `switch.toggle` na `switch.sh_04_lustr_jidelna`
